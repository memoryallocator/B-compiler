A B programming language compiler written in Rust

Usage: b-compiler --input=INPUT_FILE
...
--platform=PLATFORM — set the target platform. The only available options are "win", "windows", "linux". The case is ignored
